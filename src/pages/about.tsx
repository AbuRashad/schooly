...
const content = {
  ...
  en: {
    ...
    ctaBtn: "Contact Me",
    ctaEmail: "abdallah.ewina@gmail.com",
    ...
    <>
      ...
      >
        ...
        <section className="relative z-10 px-6 md:px-16 py-20 text-center">
          ...
          >
            ...
            <p className="text-sm text-white/50 mb-6">
              <a href={`mailto:${(t as any).ctaEmail}`} className="text-primary hover:underline">
                {(t as any).ctaEmail}
              </a>
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              <a href={`mailto:${(t as any).ctaEmail}`}>
                <motion.button
        ...
        <footer className="relative z-10 text-center text-white/30 text-sm pb-8 pt-4 border-t border-white/10">
          © 2026 School Smart Eye — Eng. <a href="mailto:abdallah.ewina@gmail.com" className="text-primary/60 hover:text-primary hover:underline transition-colors">Abdallah Rashad Oweina</a>
        </footer>
      </div>
    </>
  );
