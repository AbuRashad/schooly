...
import {
  ...
  ChevronRight, FileText, Download, Filter, RefreshCw,
...
export default function ReportsPage() {
  ...
  return (
    <div dir="rtl" className="flex h-screen overflow-hidden" style={{ background: '#060f1e', color: 'white' }}>
      <title>التقارير — School Smart Eye</title>
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="flex items-center justify-between px-5 py-3.5 flex-shrink-0"
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-sm font-bold text-white">التقارير</h1>
              <p className="text-[11px] text-white/35">توليد وتصدير تقارير الطلاب والحضور</p>
            </div>
          </div>
