...
If port `5173` is already in use, Vite will automatically choose another port (for example `5174`).  
Always open the exact URL printed in the terminal.

### Windows PowerShell note

If PowerShell blocks `npm` scripts with an execution policy error, use:
...
**Eng. Abdallah Rashad Oweina**

Founder & Lead Developer of School Smart Eye — an AI-powered education platform built with passion for transforming how schools monitor academic performance, track attendance, and deliver smart reports.

📧 **Email:** [abdallah.ewina@gmail.com](mailto:abdallah.ewina@gmail.com)
