...
from app.api.v1.endpoints.camera_agent import router as camera_agent_router
from app.api.v1.endpoints.cameras import router as cameras_router
from app.api.v1.endpoints.computer_vision_agent import router as computer_vision_agent_router
...
api_router.include_router(camera_agent_router)
api_router.include_router(computer_vision_agent_router)
